...
class Rule 
{
	...
	/**
	 *  number of times value appears in dice
	 */ 
	count(dice, val) 
	{
...
class SumDistro extends Rule 
{
	evalRoll = dice => 
	{
		...
		return this.freq(dice).some(cnt => cnt >= this.count) ? this.sum(dice) : 0;
	};
}
 ...
 * 
 * Small straight must be 4 different dice that either doesn't 
 * have 1 and 6, 1 and 2 or 5 and 6
 */
...
// By making count: 0 it short circuits the SumDistro and returns 
